...
var account_credentials_1 = require("../../lib/validators/account-credentials");
var trpc_1 = require("../trpc");
exports.authRouter = (0, trpc_1.router)({
    createPayloadUser: trpc_1.publicProcedure
        .input(account_credentials_1.SignUpAuthCredentialsValidator)
    ...
    signIn: trpc_1.publicProcedure
        .input(account_credentials_1.SignInAuthCredentialsValidator)
        .mutation(function (_a) {
